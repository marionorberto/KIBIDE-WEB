    ...
    <div class="card table-card">
      ...
      <div class="table-responsive">
        ...
        <tbody>
          ...
          <td>Honduras</td>
          <td>
            <span class="badge bg-light-primary rounded-pill f-12">Pending</span>
          </td>
          <td class="text-center">
            <ul class="list-inline me-auto mb-0">
            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
          ...
          <td>Azerbaijan</td>
          <td>
            <span class="badge bg-light-danger rounded-pill f-12">Rejected</span>
          </td>
          <td class="text-center">
            <ul class="list-inline me-auto mb-0">
            <li class="list-inline-item align-bottom" data-bs-toggle="tooltip" title="View">
          ...
          <td>
            <div class="row">
            <div class="col-auto pe-0">
              <img src="../assets/images/user/avatar-6.jpg" alt="user-image" class="wid-40 rounded-circle" />
            </div>
            <div class="col">
              <h5 class="mb-0">Addie Bass</h5>
              <p class="text-muted f-12 mb-0">
          ...
          <td>
            <div class="row">
            <div class="col-auto pe-0">
              <img src="../assets/images/user/avatar-7.jpg" alt="user-image" class="wid-40 rounded-circle" />
            </div>
            <div class="col">
              <h5 class="mb-0">Agnes McGee</h5>
              <p class="text-muted f-12 mb-0">
          ...
          <td>
            <div class="row">
            <div class="col-auto pe-0">
              <img src="../assets/images/user/avatar-8.jpg" alt="user-image" class="wid-40 rounded-circle" />
            </div>
            <div class="col">
              <h5 class="mb-0">
              Alberta Robbins
          ...
          <td>
            <div class="row">
            <div class="col-auto pe-0">
              <img src="../assets/images/user/avatar-9.jpg" alt="user-image" class="wid-40 rounded-circle" />
            </div>
            <div class="col">
              <h5 class="mb-0">Agnes McGee</h5>
              <p class="text-muted f-12 mb-0">
      ...
      <div class="row">
        ...
        <div class="card">
          ...
          <ul class="list-group list-group-flush">
            ...
            <h6 class="mb-0">
              647 Punam Center, Ulabifgu, Myanmar
              (Burma) - 41487
            </h6>
            </li>
          </ul>
        ...
        <div class="card">
          ...
          <div class="card-body">
          <p class="mb-0">
            Hello, I’m Aaron Poole Manufacturing
            Director based in international company,
            Void jiidki me na fep juih ced gihhiwi
            launke cu mig tujum peodpo.
          </p>
          </div>
        </div>
        </div>
