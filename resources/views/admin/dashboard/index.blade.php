  ...
  <div class="row">
    ...
    <div class="card">
      ...
      <div class="col-md-6">
        ...
        <p class="text-muted text-sm mb-0">Chrome fixed the bug several versions ago, thus rendering this...
        </p>
        </div>
      </div>
      </div>
    ...
    <div class="card">
      ...
      <div class="d-flex align-items-center">
        ...
        <p class="text-muted mb-0">All your income salaries and budget comes here, you can track them or manage
          them</p>
        </div>
      </div>
      </div>
