...
@section('content')
  ...
  <div class="row">
    ...
    <div class="card">
      <div class="card-body">
      <h6 class="mb-2 f-w-400 text-muted">Total Tickets</h6>
    ...
    <div class="card">
      <div class="card-body">
      <h6 class="mb-2 f-w-400 text-muted">Total </h6>
    ...
    <div class="card">
      ...
      <div class="d-flex align-items-center">
        ...
        <p class="text-muted mb-0">All your income salaries and budget comes here, you can track them or manage them
        </p>
        </div>
      </div>
      </div>
