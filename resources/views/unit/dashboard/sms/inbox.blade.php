...
@section('content')
  ...
  <div class="col-xl-8">
    ...
    <div class="card-header">
      <h5>Caixa de Entrada <span class="ms-2 f-14 px-2 badge bg-light-secondary rounded-pill">0</span></h5>
    </div>
    <div class="mx-4 mt-3 alert alert-warning text-center w-full" role="alert"> Sem mensagem recebidas até ao momento!
    </div>
    <div class="card-body">
