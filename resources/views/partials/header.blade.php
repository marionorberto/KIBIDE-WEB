          ...
          <div class="dropdown-menu pc-h-dropdown pc-mega-dmenu">
            <div class="row g-0">
              <div class="col image-block">
                ...
                <p class="text-white my-4">Try our pre made component pages to check how it feels and suits as per your
                  need.</p>
              ...
              <div class="col">
                ...
                <ul class="pc-mega-list">
                  ...
                  <li><a href="#!" class="dropdown-item"><i class="ti ti-circle"></i> Progress Bars &amp; Graphs</a>
                  </li>
