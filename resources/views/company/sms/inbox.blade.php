...
@section('content')
  ...
  <div class="col-xl-10">
    ...
    <div class="card-header d-flex justify-content-between align-items-center">
      <h5>Caixa de entrada <span
        class="ms-2 f-14 px-2 badge bg-light-secondary rounded-pill">{{ $myMessages->count() }}</span></h5>
      <a href="{{ route('company.create.sms') }}" class="btn btn-primary">Criar Nova Mensagem</a>
