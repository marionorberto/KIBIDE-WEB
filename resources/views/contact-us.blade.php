...
<head>
  <title>Contact Us | Mantis Bootstrap 5 Admin Template</title>
  <!-- [Meta] -->
  <meta charset="utf-8">
      ...
      <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
          <li class="nav-item px-1">
            <a class="nav-link" href="https://codedthemes.gitbook.io/mantis-bootstrap/"
          ...
          <li class="nav-item px-1 me-2 mb-2 mb-md-0">
            <a class="btn btn-icon btn-secondary" target="_blank"
              href="https://github.com/codedthemes/mantis-free-bootstrap-admin-template/tree/master"><i
  ...
  <header class="contact-hero">
    <div class="container">
      <div class="row justify-content-between align-items-center">
        <div class="col-md-5">
          <h2>Talk to our <span class="text-primary">Expert</span></h2>
    ...
    <div class="container">
      <div class="row justify-content-center text-center">
        <div class="col-md-10 col-xl-5 mb-4">
          ...
          <p class="text-muted">The starting point for your next project based on easy-to-customize Material-UI © helps
        ...
        <div class="col-xxl-6 col-md-8 col-sm-10">
          ...
          <div class="form-check">
            ...
            <label class="form-check-label" for="flexCheckChecked">
              By submitting this, you agree to the<a href="#" class="link-primary"> Privacy Policy </a> and <a href="#"
                class="link-primary">CookiePolicy</a>
            </label>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-4">
            ...
            <p>Since 2017, More than 50K+ Developers trust the CodedThemes Digital Product. Mantis is Manage under their
